...
class DeepgramClientBuilder
{
    ...
    public function apiKeyAuthCredentials(ApiKeyAuthCredentialsBuilder $apiKeyAuth): self
    {
        $this->config = array_merge($this->config, $apiKeyAuth->getConfiguration());
        return $this;
    }

    public function jwtAuthCredentials(JwtAuthCredentialsBuilder $jwtAuth): self
    {
        $this->config = array_merge($this->config, $jwtAuth->getConfiguration());
        return $this;
    }
    ...
    public function build(): DeepgramClient
    {
        return new DeepgramClient($this->config);
    }
}
